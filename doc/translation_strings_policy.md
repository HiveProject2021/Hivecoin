...
This document provides guidelines for internationalization of the Hive Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `hive_en.ts` remains unchanged.
