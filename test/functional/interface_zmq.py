...
import os
import struct
from test_framework.test_framework import HiveTestFramework, SkipTest
...
# noinspection PyUnresolvedReferences
class ZMQTest(HiveTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that hive has been built with ZMQ enabled.
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            raise SkipTest("hived has not been built with zmq enabled.")
