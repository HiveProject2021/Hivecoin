...
# TestNode: A peer we use to send messages to hived, and store responses.
...
class CompactBlocksTest(HiveTestFramework):
    ...
    # This test actually causes hived to (reasonably!) disconnect us, so do this last.
    ...
    # Test that hived requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for hived to be smart enough to know we're
    ...
    def test_getblocktxn_handler(node, test_node, version):
        # hived will not send blocktxn responses for blocks whose height is
