...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the HiveTestFramework
    pass

class ExampleTest(HiveTestFramework):
    # Each functional test is a subclass of the HiveTestFramework class.
    ...
    def custom_method(self):
        ...
        HiveTestFramework class so other tests can use it."""
