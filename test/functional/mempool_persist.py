...
By default, hived will dump mempool on shutdown and
...
class MempoolPersistTest(HiveTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(1)
        # Give hived a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent hived from writing mempool.dat to disk. Verify that `savemempool` fails")
