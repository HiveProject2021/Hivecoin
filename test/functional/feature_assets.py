...
class AssetTest(HiveTestFramework):
    ...
    def big_test(self):
        ...
        n0.listassets(asset="HIVE*", verbose=False, count=2, start=-2)
        ...
        hive_assets = n0.listassets(asset="HIVE*", verbose=False, count=2, start=-2)
        assert_equal(len(hive_assets), 2)
        assert_equal(hive_assets[0], "HIVE2")
        assert_equal(hive_assets[1], "HIVE3")
        self.sync_all()
