...
class WalletTest(HiveTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 HVN from 0 to 2 using sendtoaddress call.
        ...
        # Send 10 HVN with subtract fee from amount
        ...
        # Sendmany 10 HVN with subtract fee from amount
