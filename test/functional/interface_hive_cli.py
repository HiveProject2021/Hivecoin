...
class TestHiveCli(HiveTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getinfo RPC and `hive-cli getinfo`")
        ...
        self.log.info("Compare responses from `hive-cli -getinfo` and the RPCs data is retrieved from.")
