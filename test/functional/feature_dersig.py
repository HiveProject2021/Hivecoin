...
class BIP66Test(HiveTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # hived is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and hived produces more specific reject
            # reasons.
