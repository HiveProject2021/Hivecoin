...
#ifndef HIVE_TEST_SCRIPTNUM10_H
#define HIVE_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Hive Core 0.10.0, for cross-comparison.
 */
public:
