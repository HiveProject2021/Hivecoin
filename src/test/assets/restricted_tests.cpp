...
BOOST_FIXTURE_TEST_SUITE(restricted_tests, BasicTestingSetup)
    ...
    BOOST_AUTO_TEST_CASE(verify_new_restricted_transaction_test) {
        ...
        // Create filler hvn tx
        CScript hvnTransfer = GetScriptForDestination(DecodeDestination(GetParams().GlobalBurnAddress()));
        CTxOut hvnOut(1*COIN, hvnTransfer);
        ...
        mutTxTest1.vout.emplace_back(hvnOut);
        ...
        mutTxTest2.vout.emplace_back(hvnOut);
        ...
        mutTxTest3.vout.emplace_back(hvnOut);
        ...
        mutTxTest4.vout.emplace_back(hvnOut);
        ...
        mutTxTest5.vout.emplace_back(hvnOut);
        ...
        mutTxTest6.vout.emplace_back(hvnOut);
        ...
        mutTxTest7.vout.emplace_back(hvnOut);
        ...
        mutTxTest8.vout.emplace_back(hvnOut);
