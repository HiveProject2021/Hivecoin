...
#ifndef HIVECOIN_ASSET_PROTOCOL_H
#define HIVECOIN_ASSET_PROTOCOL_H
...
bool CheckIssueDataTx(const CTxOut& txOut); // OP_HIVE_ASSET HVNQ (That is a Q as in Que not an O)
bool CheckOwnerDataTx(const CTxOut& txOut);// OP_HIVE_ASSET HVNO
bool CheckReissueDataTx(const CTxOut& txOut);// OP_HIVE_ASSET HVNR
bool CheckTransferOwnerTx(const CTxOut& txOut);// OP_HIVE_ASSET HVNT
...
#endif //HIVECOIN_ASSET_PROTOCOL_H
