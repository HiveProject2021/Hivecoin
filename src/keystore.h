...
#ifndef HIVE_KEYSTORE_H
#define HIVE_KEYSTORE_H
...
public:
    ...
    //! Support for BIP 0013 : see https://github.com/HiveProject2021/bips/blob/master/bip-0013.mediawiki
