...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<HiveAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_hive-qt -platform xcb      # Linux
//     src/qt/test/test_hive-qt -platform windows  # Windows
//     src/qt/test/test_hive-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = HiveUnits::formatWithUnit(unit, balance, false, HiveUnits::separatorAlways);
    ...
    // Amount input
    HiveAmountField* amountInput = receiveCoinsDialog.findChild<HiveAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: hive:")) != -1);
