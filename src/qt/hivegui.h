...
#ifndef HIVE_QT_HIVEGUI_H
#define HIVE_QT_HIVEGUI_H
...
/**
  Hive GUI main class. This class represents the main window of the Hive UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class HiveGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit HiveGUI(const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = 0);
    ~HiveGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a hive wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
