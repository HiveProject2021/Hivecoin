...
#ifndef HIVE_QT_HIVEUNITS_H
#define HIVE_QT_HIVEUNITS_H
...
*/
class HiveUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit HiveUnits(QObject *parent);

    /** Hive units.
      @note Source: https://en.hive.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        HVN,
...
typedef HiveUnits::Unit HiveUnit;

#endif // HIVE_QT_HIVEUNITS_H
