...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatHiveURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + HiveUnits::formatHtmlWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatHiveURI(info));
}
