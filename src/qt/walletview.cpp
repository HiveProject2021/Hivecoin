...
void WalletView::setHiveGUI(HiveGUI *gui)
{
    if (gui)
    {
...
void WalletView::setWalletModel(WalletModel *_walletModel)
{
    ...
    if (_walletModel)
    {
        ...
        // update HD status
        Q_EMIT hdEnabledStatusChanged(_walletModel->hd44Enabled() ? HiveGUI::HD44_ENABLED : _walletModel->hdEnabled() ? HiveGUI::HD_ENABLED : HiveGUI::HD_DISABLED);
