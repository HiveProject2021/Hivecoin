...
#ifndef HIVE_SCRIPT_STANDARD_H
#define HIVE_SCRIPT_STANDARD_H
...
enum txnouttype
{
    ...
    TX_RESTRICTED_ASSET_DATA = 11, //!< unspendable OP_HIVE_ASSET script that carries data
    /** HVN END */
};
 ...
 *  A CTxDestination is the internal data type encoded in a hivecoin address
 */
...
/**
 * Generate a Hive scriptPubKey for the given CTxDestination. Returns a P2PKH
